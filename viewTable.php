 ...
 <div class="span12">
   <div class="widget no-margin">
     ...
     <div class="widget-body">
      ...
      <!.. monthly uodate ..>
                      <td><a href="monthlyUpdate.php?emp_id=<?php echo $emp_id?>" role="button" class="btn btn-small  btn-success">
                              Monthly Update
                          </a>
                        </td>
...
<!.. information update ..>
                  ...
                  <td><a href="update_guardInfo.php?emp_id=<?php echo $emp_id?>" role="button" class="btn btn-small btn-primary hidden-tablet hidden-phone">
                   Update
                 </a> </td>
